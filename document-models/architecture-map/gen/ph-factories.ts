/**
 * Factory methods for creating ArchitectureMapDocument instances
 */
...
export function defaultGlobalState(): ArchitectureMapGlobalState {
  return {
    categories: [
      {
        id: "cat-finance",
    ...
    relationships: [
      ...
      },
      {
        ...
        relationshipType: "Reference",
        description:
          "Builder profile references its operational hub membership",
      },
      {
        id: "r-bld-bp",
      ...
      },
      {
        ...
        relationshipType: "Reference",
        description:
          "Snapshot report references accounts for fund flow tracking",
      },
      {
        id: "r-sr-at",
        sourceModelType: "powerhouse/snapshot-report",
    ...
    driveApps: [
      ...
      },
      {
        ...
        slug: "finances",
        description:
          "Drive app for account management and transaction tracking",
        color: "#f472b6",
...
export function defaultLocalState(): ArchitectureMapLocalState {
  return {};
}

export function defaultPHState(): ArchitectureMapPHState {
  return {
    ...defaultBaseState(),
...
export function createGlobalState(
  state?: Partial<ArchitectureMapGlobalState>,
): ArchitectureMapGlobalState {
  return {
    ...defaultGlobalState(),
    ...(state || {}),
  } as ArchitectureMapGlobalState;
}

export function createLocalState(
  state?: Partial<ArchitectureMapLocalState>,
): ArchitectureMapLocalState {
  return {
    ...defaultLocalState(),
    ...(state || {}),
  } as ArchitectureMapLocalState;
}

export function createState(
  baseState?: Partial<PHBaseState>,
  globalState?: Partial<ArchitectureMapGlobalState>,
  localState?: Partial<ArchitectureMapLocalState>,
): ArchitectureMapPHState {
  return {
...
/**
 * Creates a ArchitectureMapDocument with custom global and local state
 * This properly handles the PHBaseState requirements while allowing
 * document-specific state to be set.
 */
export function createArchitectureMapDocument(
  state?: Partial<{
    auth?: Partial<PHAuthState>;
    document?: Partial<PHDocumentState>;
    global?: Partial<ArchitectureMapGlobalState>;
    local?: Partial<ArchitectureMapLocalState>;
  }>,
): ArchitectureMapDocument {
